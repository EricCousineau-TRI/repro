# from: https://github.com/PyTorchLightning/pytorch-lightning/blob/1.2.0/pytorch_lightning/plugins/training_type/ddp_spawn.py
...
class DDPForkPlugin(ParallelPlugin):
    ...
    def start_training(self, trainer):
        _mp_fork(self.new_process, **self.mp_fork_kwargs)
    ...
    def new_process(self, process_idx, trainer, mp_queue):
        ...
        # persist info in ddp_fork
        self.transfer_distrib_fork_state_on_fit_end(results)
    ...
    def init_ddp_connection(self, global_rank: int, world_size: int) -> None:
        # TODO: this code is duplicated in DDP and DDPFork, make this a function
    ...
    def transfer_distrib_fork_state_on_fit_end(self, results):
