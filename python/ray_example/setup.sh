...
# Sources or uses virtualenv environment.
# If the environment is out of sync, it will try to update them.
#
...
if [[ ${0} == ${BASH_SOURCE} ]]; then
    ...
    # This is sourced. Clean up.
    unset _cur_dir _venv_dir
    unset -f _setup_venv
fi
